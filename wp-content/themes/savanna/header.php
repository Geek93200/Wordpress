...
<script>
	...
	jQuery('a.featured').live('mouseenter',function(){
		jQuery('.hover', this).animate({'opacity': 1}, 300);
	});
	jQuery('a.featured').live('mouseleave',function(){
		jQuery('.hover', this).animate({'opacity': 0}, 300);
	});
